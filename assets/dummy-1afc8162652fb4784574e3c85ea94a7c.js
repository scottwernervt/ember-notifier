...
Object.defineProperty(e,"__esModule",{value:true})
Object.defineProperty(e,"default",{enumerable:true,get:function e(){return t.default}})})
define("dummy/controllers/application-tailwind",["exports","dummy/tailwind/config/colors","dummy/tailwind/config/screens","dummy/tailwind/config/fonts","dummy/tailwind/config/text-sizes","dummy/tailwind/config/font-weights","dummy/tailwind/config/line-height","dummy/tailwind/config/letter-spacing","dummy/tailwind/config/border-widths","dummy/tailwind/config/border-radius","dummy/tailwind/config/width","dummy/tailwind/config/height","dummy/tailwind/config/min-width","dummy/tailwind/config/min-height","dummy/tailwind/config/max-width","dummy/tailwind/config/max-height","dummy/tailwind/config/padding","dummy/tailwind/config/margin","dummy/tailwind/config/negative-margin","dummy/tailwind/config/shadows","dummy/tailwind/config/z-index","dummy/tailwind/config/opacity","dummy/tailwind/config/svg-fill","dummy/tailwind/config/svg-stroke"],function(e,t,n,r,o,i,s,u,a,l,d,c,m,f,p,b,y,h,g,v,j,x,w,_){"use strict"
Object.defineProperty(e,"__esModule",{value:true})
e.default=void 0
var O={colors:t.default,screens:n.default,fonts:r.default,textSizes:o.default,fontWeights:i.default,leading:s.default,tracking:u.default,borderWidths:a.default,borderRadius:l.default,width:d.default,height:c.default,minWidth:m.default,minHeight:f.default,maxWidth:p.default,maxHeight:b.default,padding:y.default,margin:h.default,negativeMargin:g.default,shadows:v.default,zIndex:j.default,opacity:x.default,svgFill:w.default,svgStroke:_.default}
